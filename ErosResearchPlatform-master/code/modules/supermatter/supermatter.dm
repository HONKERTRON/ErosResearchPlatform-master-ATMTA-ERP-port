...
#define THERMAL_RELEASE_MODIFIER 10000		//Higher == more heat released during reaction //should be 750 for old values
#define PHORON_RELEASE_MODIFIER 1500		//Higher == less phoron released by reaction
#define OXYGEN_RELEASE_MODIFIER 15000		//Higher == less oxygen released at high temperature/power //should be 1500 for old values
...
#define CRITICAL_TEMPERATURE 5000	//K //should be 800 for old values
